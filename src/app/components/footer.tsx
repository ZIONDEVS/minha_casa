...
export default function Footer() {
    return (
        <footer className="bg-[#72A66A] lg:h-[411px] text-white py-[40px]">
            <div>
                ...
                <div className="w-full lg:pl-[120px] mt-8 lg:border-t-[2px] border-white/20 pt-4 flex flex-col md:flex-row justify-between text-[16px] lg:pt-[30px]">
                    {/* Política de privacidade e Copyright */}
                    ...
                    {/* Imagem line_1 (aparece apenas em mobile) */}
                    ...
                    {/* Desenvolvido por Zion (agora no final para mobile) */}
